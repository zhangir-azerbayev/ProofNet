...
theorem exercise_2018.b4 {a : ℝ} (h : ∃ n, x n = 0) : 
    ∃ (p : ℕ), ∀ (n : ℕ), x (n + p) = x n :=
sorry
...
theorem exercise_2017.b3 {f : ℚ → ℚ} (hf : is_power_series f) 
