theorem exercise_13.1 (X : Type*) [topological_space X]
  (A : set X) (hA : ∀ x ∈ A, ∃ U : set X, is_open U ∧ x ∈ U ∧ U ⊆ A): 
  is_open A :=
sorry

theorem exercise_13.5a {X : Type*} 
...
theorem exercise_13.5b (X : Type*) (A : set (set X)) 
    (hA : is_subbasis A) :
    @topology.generate X A = ⋂₀ {U | is_topology U ∧ A ⊆ U} :=
sorry

theorem exercise_16.1 {X : Type*} [topological_space X] 
    {Y : set X} [is_subspace Y] {A : set Y} [is_subspace A] (hA : A ⊆ Y) :
    subtype.topology A = subtype.topology (A : set X) :=
sorry

theorem exercise_16.4 {X Y : Type*} [topological_space X] [topological_space Y] :
    is_open (pi_1 : X × Y → X) :=
sorry
...
theorem exercise_16.9 (X Y : Type*) 
...
theorem exercise_19.4 {α : Type u} {β : Type v} {γ : Type w} 
    [topological_space α] [topological_space β] [topological_space γ] 
    (h : α ≃ β) (x : α) : 
    (β × γ) ≃ (α × γ) :=
sorry

theorem exercise_19.6a {ι : Type*} 
...
theorem exercise_19.9 {α : Type u} {β : α → Type v} 
    (h : ∀ a, nonempty (β a)) :
    nonempty (Π a, β a) ↔ ∀ a, nonempty (β a) :=
sorry

theorem exercise_20.2 (X Y : Type*) [topological_space X] 
...
theorem exercise_21.6a {x : ℝ} (hx : 0 ≤ x) (hx1 : x ≤ 1) 
    (h : tendsto (λ n, x ^ n) at_top (𝓝 1)) :
    tendsto (λ n, x ^ n) at_top (𝓝 x) :=
sorry

theorem exercise_21.6b (n : ℕ) : 
...
theorem exercise_23.4 {X : Type*} [fintype X] :
  connected (finite_compl_topology X) ↔ infinite X :=
sorry

theorem exercise_23.6 {X : Type*} 
...
theorem exercise_23.9 {X Y : Type*} 
...
theorem exercise_23.11 {X : Type*} [topological_space X]
    {Y : Type*} [topological_space Y] (p : X → Y) (hq : quotient_map p)
    (hY : connected Y) (hX : ∀ y : Y, connected (p ⁻¹' {y})) :
    connected X :=
sorry

theorem exercise_23.12 {X Y : Type*} [topological_space X] [topological_space Y]
...
theorem exercise_24.2 {f : sphere 1 → ℝ} 
    (hf : continuous f) : ∃ (x : sphere 1), f x = f (-x) :=
sorry

theorem exercise_24.3a {X : Type*} [topological_space X] 
    (f : X → X) (hf : continuous f) (hX : X = Icc 0 1) :
    ∃ (x : X), f x = x :=
sorry

theorem exercise_24.4 {X : Type*} [linear_order X] 
    [topological_space X] [order_topology X] (hX : connected_space X) :
    linear_continuum X :=
sorry

theorem exercise_24.6 {X : Type*} [linear_order X] 
    (hX : well_order X) : linear_continuum (X × Icc 0 1) :=
sorry

theorem exercise_25.4 {X : Type*} [topological_space X]
    [locally_path_connected_space X] (U : set X) (hU : is_open U) 
    (hcU : connected U) : path_connected U :=
sorry

theorem exercise_25.9 (G : Type*) [topological_group G] 
    (C : set G) (hC : is_connected G C) : 
    is_normal G C :=
sorry

theorem exercise_26.9 {X : Type*} 
...
theorem exercise_26.12 {X Y : Type*} [topological_space X]
    [topological_space Y] (p : X → Y) (hc : continuous p) (hp : ∀ y : Y, 
    is_compact (p ⁻¹' {y})) (hY : is_compact Y) : is_compact X :=
sorry

theorem exercise_27.1 (X : Type*) [linear_order X] 
...
theorem exercise_28.6 {X : Type*} [metric_space X] 
    [compact_space X] {f : X → X} (hf : isometry f) : 
    function.bijective f :=
sorry

theorem exercise_29.1 : ¬ locally_compact_space ℚ :=
sorry
...
theorem exercise_31.3 {α : Type*} [partial_order α] 
    [topological_space α] (h : order_topology α) : regular_space α :=
sorry

theorem exercise_32.1 {X : Type*} [topological_space X] 
...
theorem exercise_32.2 {X : Type*} [topological_space X]
...
theorem exercise_43.2 {X : Type*} [metric_space X]
...
theorem exercise_43.7 (X : Type*) [normed_group X] [normed_space ℝ X] :
